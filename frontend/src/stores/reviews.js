...
const reviewList = ref([
  ...
  },
  {
    ...
    tags: ['시원한 상담', '빠른 계약'],
    blocks: [
      { type: 'text', content: '장기렌트를 두번째 이용하지만 신차장기렌트전팀장 카매니저님 처럼 시원시원하게 견적과 계약을 진행해주신 분은 처음입니다. 차량도 깔끔하게 잘 받았고, 모든 과정이 만족스럽습니다^^ 친절하게 마지막까지 신경써주셔서 감사합니다^^' },
  ...
  },
  {
    ...
    tags: ['빠른 진행', '리스 세팅'],
    blocks: [
      { type: 'text', content: '카랩 처음 이용해봅니다. 간단하게 견적 봐주시고 여러 매니저분들 만나서 꽤나 타협점 찾기어려웠습니다. 그래도 매니저님 만나고 차량 리스 세팅부터 차량 확보까지 일주일이 채 안걸려서 안그래도 급한 상황이었는데 너무 감사하게도 인도 잘 받았습니다. 앞으로도 좋은일 가득하시고 번창하셨으면 좋겠습니다.' },
  ...
  },
  {
    ...
    tags: ['최저가', '빠른 출고'],
    blocks: [
      { type: 'text', content: '좋은 카매니저 님 매칭 되어서, 원하는대로 그리고 빠르게 차량 출고 받았네요. 카랩 통해서 처음 진행해 보았는데, 다른 지인 소개나 인터넷 업체보다 금액도 저렴하고 신뢰도도 높았습니다. 다음 출고도 카랩을 이용 할것 같네요. 황팀장님께도 이 자리를 빌어 감사 인사 다시 드립니다. ^^' },
  ...
  },
  {
    ...
    tags: ['꼼꼼한 상담', '재구매'],
    blocks: [
      { type: 'text', content: '신차 몇번을 구매했지만 이번에 카랩을 통해 알게된 딜러분 엄청 꼼꼼하시고 잘해주시더라구요. 다음번 구매도 그 딜러분한테 구매할 예정입니다.' },
  ...
  },
  {
    ...
    tags: ['빠른 배정', '업무용'],
    blocks: [
      { type: 'text', content: '현대·기아측에 계약 후 1개월 기약없이 6~24개월 출고대기 통보 받아 업무용 차량이라 답답해서 카랩에 의뢰한지 1일만에 차량배정, 1주일이내에 인도 받았어요 ㅎㅎ 앞으로도 신차 역시 카랩입니다. 담당 카매니저님의 세심함과 신속함에 깊은 감사드립니다!!' },
  ...
  },
  {
    ...
    tags: ['일사천리', '전팀장님'],
    blocks: [
      { type: 'text', content: '카랩에서 전팀장님과 인연이 되서 차량 선점부터 계약까지 일사천리로 빠르게 잘 출고받았습니다. 출고 후 문의사항들까지도 늘 친절한 마인드로 응대해주셔서 깊은 감사말씀 드립니다^^' },
